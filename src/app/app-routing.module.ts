...
import { AdvisoriesComponent } from './admin/advisories/advisories.component';
import { ClassInfoComponent } from './admin/class-info/class-info.component';
import { ManageSchoolyearComponent } from './admin/manage-schoolyear/manage-schoolyear.component';
...
const routes: Routes = [
  ...
  {
    path: 'manageSY',component:ManageSchoolyearComponent
  },
