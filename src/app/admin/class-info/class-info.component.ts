...
export class ClassInfoComponent implements OnInit {
  ...
  getStudentsList(data:any,sub:any){
    ...
    this.api.getEnrolledStudents(this.classid).subscribe((res:any)=> {
      // console.log("Success===",res);
  ...
  searchEnrolledStudents(cond:any){
    ...
    if (cond=='true'){
      this.api.getEnrolledStudents(this.classid).subscribe((res:any)=> {
        ...
        this.enrolledstudents=res;
        this.enrolledstudents = this.enrolledstudents.filter((classes: { studid: any; }) => classes.studid === this.searchEnrolled);
      ...
      this.api.getStudents().subscribe((res:any)=> {
        ...
        this.studentsList=res;
        this.studentsList = this.studentsList.filter((classes: { studid: any; }) => classes.studid === this.searchNotEnrolled);
